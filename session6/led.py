...
class Principal(QtGui.QFrame):
    ...
    def on_boton_led1_clicked(self):
        if self.ui.kled_1.state() == 0 :
            ...
            self.actualizar("digitalWrite(7,HIGH)")
            ...
            self.actualizar("digitalWrite(7,LOW)")
    ...
    def on_boton_led2_clicked(self):
        if self.ui.kled_2.state() == 0 :
            ...
            self.actualizar("digitalWrite(6,HIGH)")
            ...
            self.actualizar("digitalWrite(6,LOW)")
    ...
    def on_boton_led3_clicked(self):
        if self.ui.kled_3.state() == 0 :
            ...
            self.actualizar("digitalWrite(5,HIGH)")
            ...
            self.actualizar("digitalWrite(5,LOW)")
    ...
    def inicio(self):
        ...
        self.ui.boton_iniciar.setToolTip(u"Termina correctamente la Conexión y cierra la aplicación")
        ...
        if self.pinguino.pinguinoOpen() == None:
            ...
            self.actualizar("pinMode(7,OUTPUT)")
            self.actualizar("pinMode(6,OUTPUT)")
            self.actualizar("pinMode(5,OUTPUT)")
